...
export const properties: Property[] = [
  ...
  },
  {
    ...
    description: "Ready-to-use office space with modern interiors, perfect for startups and established businesses.",
    features: ["Furnished", "AC Installed", "Reception Area", "Pantry", "24/7 Security"],
    isFeatured: true,
  },
  {
    id: 6,
    ...
    description: "Well-maintained 2BHK flat ideal for small families, close to schools and markets.",
    features: ["Semi-Furnished", "Balcony", "Parking", "Near Market", "Water Supply"],
    isFeatured: true,
  },
  {
    id: 7,
    ...
    area: "2800 sq.ft",
    areaNumeric: 2800,
    image: "/placeholder.svg?key=rlmk3",
  ...
  },
  {
    ...
    area: "5 Acres",
    areaNumeric: 217800,
    image: "/placeholder.svg?key=dpgxd",
  ...
  },
  {
    ...
    area: "2500 sq.ft",
    areaNumeric: 2500,
    image: "/placeholder.svg?key=p5wg9",
  ...
  },
  {
    ...
    location: "Medical College Road, Jhansi",
    price: "₹8,000/month",
    priceNumeric: 8000,
    type: "Residential",
    status: "For Rent",
    ...
    area: "450 sq.ft",
    areaNumeric: 450,
    image: "/placeholder.svg?key=8l6db",
    description: "Compact studio apartment ideal for students and working professionals.",
    features: ["Furnished", "WiFi Ready", "Near Hospital", "24/7 Water", "Security"],
    isFeatured: false,
  },
  {
    id: 11,
    title: "Warehouse Space",
    location: "Industrial Area, Jhansi",
    price: "₹50,000/month",
    priceNumeric: 50000,
    type: "Commercial",
    status: "For Rent",
    ...
    area: "5000 sq.ft",
    areaNumeric: 5000,
    image: "/placeholder.svg?key=kzn3y",
    description: "Large warehouse space with loading dock, perfect for storage and distribution businesses.",
    features: ["Loading Dock", "High Ceiling", "Security", "Fire Safety", "Truck Access"],
    isFeatured: false,
  },
  {
    id: 12,
    ...
    area: "1600 sq.ft",
    areaNumeric: 1600,
    image: "/placeholder.svg?key=0jxdn",
